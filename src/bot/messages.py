...
LINK_VALID_TEXT = "✅ Ссылка рабочая. Кстати, МЕНЮ всегда можно вызвать через кнопку внизу слева. Тестовое уведомление:"
...
def format_listing_message(
    ...
    if is_test:
        lines.append("<b>Это тестовое объявление</b> — так будут выглядеть уведомления, только с фото.\n")
